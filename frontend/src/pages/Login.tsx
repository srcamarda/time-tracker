...
export function Login() {
  ...
  function handleSubmit(evt: FormEvent<HTMLFormElement>) {
    ...
    // TODO: Fazer requisição ao backend
    ...
    <>
      <div className="w-full h-screen flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl px-12 py-16">
          ...
          <form className='text-dim-gray flex flex-col gap-3' onSubmit={handleSubmit}>
            ...
            <Button onClick={redirectSignUp} type='button' variant="outline" className='text-peach border-peach hover:bg-melon hover:text-white duration-300 font-bold'>Cadastrar</Button>
